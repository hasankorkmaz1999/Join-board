...
const NameOfAdmin =
  "https://joinapi-ad635-default-rtdb.europe-west1.firebasedatabase.app/demoUser/users/user1ID/profile";
const user_API =
  "https://joinapi-ad635-default-rtdb.europe-west1.firebasedatabase.app/users";
...
function showData(data) {
  ...
  document.getElementById("numberUpcomming").innerHTML =
    data.tasksOnUpcomingDate;
  document.getElementById("dateUpcomming").innerHTML = data.upcomingDate;
  document.getElementById("numberTaskInBoard").innerHTML =
    data.numberDone +
    data.numberInProgress +
    data.numberAwaitingFeedback +
    data.numberTodo;
  document.getElementById("numberTaskInProgress").innerHTML =
    data.numberInProgress;
  document.getElementById("numberTaskAwaitFeedback").innerHTML =
    data.numberAwaitingFeedback;
}
