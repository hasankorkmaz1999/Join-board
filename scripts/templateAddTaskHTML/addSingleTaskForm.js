          ...
          <div class="addTaskPriorityEdit">
                        ...
                        <div class="prioFlexEdit">
                            <form class="taskFormEdit" id="taskFormEdit">
                                <button type="button" onclick="setActive(this, 'urgent')" class="addTaskPrioButtonEdit prio-urgent">Urgent
                                ...
                                <button type="button" onclick="setActive(this, 'medium')" class="addTaskPrioButtonEdit prio-medium">Medium
                                ...
                                <button type="button" onclick="setActive(this, 'low')" class="addTaskPrioButtonEdit prio-low">Low
                                    <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
